...
<img height="60" src="images/tiny-bert-loss.png"/>

1. 第一项：**词向量层损失**
   - 计算**学生词向量**`v^s`和**老师词向量**`v^t`的均方误差：<img height="40" src="images/tiny-bert-loss-emb.png" align="center"/>
...
2. 第二项：**中间层损失**
   ...
   - **注意力损失**：<img height="40" src="images/tiny-bert-loss-att.png" align="center"/>
