...
<img height="400" src="images/tiny-bert.png"/>

TinyBert的**蒸馏loss**为：

<img height="80" src="images/tiny-bert-loss.png"/>

1. 第一项：**词向量层损失**
   - 计算**学生词向量**`v^s`和**老师词向量**`v^t`的均方误差：<img height="60" src="images/tiny-bert-loss-emb.png" align="center"/>
...
2. 第二项：**中间层损失**
   ...
   - **隐层均方误差损失**：<img height="60" src="images/tiny-bert-loss-hid.png" align="center"/>
     - 学生的第`i`层隐层输出 和 老师的第`j`层隐层输出 计算MSE，用`W^ℎ`做映射
   - **注意力损失**：<img height="60" src="images/tiny-bert-loss-att.png" align="center"/>
     - 学生第`i`层多头注意力矩阵和老师第`j`层多头注意力矩阵计算MSE，`K`为head数
3. 第三项：**预测层损失**
...
<img height="400" src="images/tiny-bert-two-stage.png"/>
