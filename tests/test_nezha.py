...
class MyTestCase(unittest.TestCase):
    def test_bert2classification(self):
        ...
        pretrained_model_dir, model_dir = './models/nezha-base-wwm', './tests/test_model'
        texts = [
            '天气真好',
            '今天运气很差',
        ]
        ...
        trainer = ClassificationTrainer(pretrained_model_dir, model_dir)
    ...
    def test_bert2sequence_labeling(self):
        ...
        trainer = SequenceLabelingTrainer(pretrained_model_dir, model_dir)
        trainer.train(texts, labels, validate_texts=texts, validate_labels=labels, batch_size=2, epoch=20)
